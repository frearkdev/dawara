    ...
    <AdminLayout title="Diensten">
        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            >
                ...
                <div class="mb-3 text-xs leading-relaxed text-stone-400">
                    {{ s.description }}
                </div>
                    ...
                    <span
                        ...
                        :class="
                            s.active
                                ...
                                : 'bg-stone-700/60 text-stone-300 ring-1 ring-stone-600'
                        "
                    >
        ...
        >
            <div
                class="w-full max-w-md rounded-[1.5rem] border border-stone-700 bg-stone-950 p-6 shadow-[0_30px_100px_rgba(0,0,0,0.4)]"
            >
                ...
                <form @submit.prevent="saveService" class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-xs text-stone-500">
                                {{ (form.price_cents / 100).toFixed(2) }} EUR
                            </p>
                        </div>
                    </div>
                    <div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
                    ...
                    <div class="flex gap-2 pt-2">
                        ...
                        <button
                            type="button"
                            @click="closeForm"
                            class="flex-1 rounded-md border border-stone-700 py-2.5 text-xs text-stone-300 transition-colors hover:border-stone-500 hover:bg-white/5"
                        >
                            Annuleren
                        </button>
                    </div>
