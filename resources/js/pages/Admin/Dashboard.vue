<template>
    <AdminLayout title="Dashboard">
        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
            ...
            >
                <div
                    class="flex items-center justify-between border-b border-stone-700 px-5 py-4"
                >
                    <h2 class="text-sm font-medium text-white">Vandaag</h2>
                    <span class="text-xs text-stone-500"
                        >{{ todayAppointments.length }} afspraken</span
                    >
                </div>
                <div
                ...
                <div v-else class="divide-y divide-stone-700">
                    ...
                    >
                        <div
                            class="w-full text-left sm:w-12 sm:flex-shrink-0 sm:text-center"
                        >
                ...
                <div v-else class="divide-y divide-stone-700">
                    ...
                    >
                        ...
                        <div class="text-left sm:flex-shrink-0 sm:text-right">
                            <div class="text-xs font-medium text-stone-200">
                                {{ a.starts_at }}
                            </div>
                            <div class="text-xs text-stone-500">
                                {{ a.barber_name }}
