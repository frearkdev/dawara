...
<template>
    <AdminLayout title="Instellingen">
        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
            <!-- Business Info -->
            <div
                class="overflow-hidden rounded-[1.25rem] border border-stone-700 bg-stone-900 p-6"
            >
            ...
            >
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            <div class="text-xs font-medium text-white">
                                Boekingen accepteren
                            </div>
                            <div class="text-[11px] text-stone-400">
                                Sta online boekingen toe
                            </div>
                        </div>
                        <label
                        ...
                        >
                            ...
                            />
                            <div
                                class="h-5 w-9 rounded-full bg-stone-700 transition-colors peer-checked:bg-amber-500 peer-focus:ring-2 peer-focus:ring-amber-500/30"
                            />
                            <div
                ...
                <h2 class="mt-8 mb-5 text-sm font-medium text-white">
                    Openingstijden
                </h2>
                <div class="space-y-2">
                    <div
                    ...
                    >
                        <div
                            class="w-24 flex-shrink-0 text-xs font-medium text-stone-300"
                        >
                            {{ dayNames[day] }}
                        </div>
                        <label
                            class="relative mr-2 inline-flex cursor-pointer items-center"
                        >
                            <input
                            ...
                            />
                            <div
                                class="h-5 w-9 rounded-full bg-stone-700 transition-colors peer-checked:bg-amber-500"
                            />
                            <div
                                class="absolute top-0.5 left-0.5 h-4 w-4 rounded-full bg-white transition-transform peer-checked:translate-x-4"
                            />
