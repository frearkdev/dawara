    ...
    <header class="sticky top-0 z-50 border-b border-stone-700/60 bg-stone-950/90 backdrop-blur-xl">
        <div class="section-shell flex h-16 items-center justify-between gap-4 md:h-20">
            ...
            <nav class="hidden items-center gap-8 lg:flex">
                <a href="/#diensten" class="text-xs uppercase tracking-[0.28em] text-stone-400 transition-colors hover:text-white">Diensten</a>
                <a href="/#team" class="text-xs uppercase tracking-[0.28em] text-stone-400 transition-colors hover:text-white">Team</a>
                <a href="/#reviews" class="text-xs uppercase tracking-[0.28em] text-stone-400 transition-colors hover:text-white">Reviews</a>
                <a href="/#contact" class="text-xs uppercase tracking-[0.28em] text-stone-400 transition-colors hover:text-white">Contact</a>
            </nav>
...
<!--                </template>-->
                ...
                >
                    ...
                    <svg v-if="!mobileMenuOpen" viewBox="0 0 24 24" class="size-5" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round">
                        <path d="M4 7h16" />
                        <path d="M4 12h16" />
                        <path d="M4 17h16" />
                    </svg>
            ...
            <div v-if="mobileMenuOpen" class="border-t border-stone-700/60 bg-stone-950 lg:hidden">
                <div class="section-shell py-4">
                    <nav class="grid gap-2 text-sm">
                    <a href="/#diensten" class="rounded-lg border border-stone-800 px-4 py-3 text-stone-300 transition-colors hover:border-stone-600 hover:bg-white/5" @click="closeMobileMenu">Diensten</a>
                    <a href="/#team" class="rounded-lg border border-stone-800 px-4 py-3 text-stone-300 transition-colors hover:border-stone-600 hover:bg-white/5" @click="closeMobileMenu">Team</a>
                    <a href="/#reviews" class="rounded-lg border border-stone-800 px-4 py-3 text-stone-300 transition-colors hover:border-stone-600 hover:bg-white/5" @click="closeMobileMenu">Reviews</a>
                    <a href="/#contact" class="rounded-lg border border-stone-800 px-4 py-3 text-stone-300 transition-colors hover:border-stone-600 hover:bg-white/5" @click="closeMobileMenu">Contact</a>
