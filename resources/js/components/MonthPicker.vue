    ...
    <div class="w-full">
        <div class="mb-3 flex items-center justify-between">
            <button
                type="button"
                @click="prevMonth"
                class="rounded-md p-2 text-white hover:bg-white/5"
            >
                <-
            </button>
            <div class="flex-1 text-center text-sm font-medium text-stone-100">
                {{ monthLabel }}
            </div>
            <button
                type="button"
        ...
        <div
            class="mb-2 grid grid-cols-7 gap-2 text-center text-xs text-stone-400"
        >
        ...
        <div class="grid grid-cols-7 gap-2 text-center">
            ...
            >
                <button
                    ...
                    class="mx-auto flex h-10 w-10 items-center justify-center rounded-full transition-colors transition-transform focus:outline-none"
                    :class="
                        cell.selected
                            ? 'scale-[1.03] bg-white text-stone-900 shadow-md'
                            : cell.disabled
...
const monthLabel = computed(() =>
    currentMonth.value.toLocaleString('nl-NL', {
        month: 'long',
        year: 'numeric',
    }),
);
